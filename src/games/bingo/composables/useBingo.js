import { ref } from 'vue'
import { supabase } from '../../../lib/supabaseClient' // <-- Cambia: Sube tres niveles (../../../)
import { tieneLinea } from '../utils/bingoRules'       // <-- Cambia: Ahora las reglas están en la carpeta utils de BINGO
